...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['password'])) {
    ...
    // Contraseña de acceso de Mariana
...
// Si el administrador NO ha iniciado sesión, mostrar pantalla de acceso
    ...
    <div class="login-card-luxury">
        ...
        <form action="admin.php" method="POST">
            <div class="form-group-luxury">
                <label for="password">Contraseña de Administradora</label>
            ...
            <button type="submit" class="btn-luxury">Ingresar a la Agenda</button>
        </form>
